...
Terrorblade.option = Menu.AddOptionBool({"Heroes by KZ", "Terrorblade"}, "Terrorblade", false)
Terrorblade.optionTarget = Menu.AddOptionSlider({"Heroes by KZ", "Terrorblade"}, "Target Radius", 200, 1000, 500)
Terrorblade.optionComboKey = Menu.AddKeyOption({"Heroes by KZ", "Terrorblade"}, "Combo key", Enum.ButtonCode.BUTTON_CODE_NONE)
Terrorblade.optionDiffusal  = Menu.AddOptionBool({"Heroes by KZ", "Terrorblade", "Items"}, "Diffusal", false)
Terrorblade.optionManta  = Menu.AddOptionBool({"Heroes by KZ", "Terrorblade", "Items"}, "Manta", false)
Terrorblade.optionBkb  = Menu.AddOptionBool({"Heroes by KZ", "Terrorblade", "Items"}, "Bkb", false)
Terrorblade.optionAutoUlt = Menu.AddOptionBool({"Heroes by KZ", "Terrorblade"}, "Auto ultimate", false)
Terrorblade.optionUltSlider = Menu.AddOptionSlider({"Heroes by KZ", "Terrorblade"}, "HP threshold", 10 ,50, 30)
